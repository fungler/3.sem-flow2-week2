...
var reduceNums = [2, 3, 67, 33];
var sum = reduceNums.reduce(function(accum, currNum) {
...
var avg = members.reduce(function(acc, curr, index) {
        return acc + curr.age;
}, 0);
...
var vote = votes.reduce(function(acc, curr, index, arr) {
